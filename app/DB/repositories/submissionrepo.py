...
class SubmissionRepo:
    def __init__(self,conn:Connection):
        self.conn = conn
    async def add_submission(self,team_id:str,requirement_id:int,submitted_by:int,document_name:str,document_path:str,version:int):
        await self.conn.execute("insert into submissions(team_id,requirement_id,submitted_by,document_name,document_path,version) values ($1,$2,$3,$4,$5,$6)",team_id,requirement_id,submitted_by,document_name,document_path,version)
